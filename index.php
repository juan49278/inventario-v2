  ...
  <main id="main">
      ...
      <div class="modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table form-control-sm table-bordered border-primary" id="bodyProductTable">
              <thead>
                <tr class="form-control-sm">
                  ...
                  <th scope="col-span-2" class="d-none">Código2</th>
                  <th scope="col-span-2" class="d-none">Código3</th>
                  <th scope="col-span-2" class="d-none">Código4</th>
                  <th scope="col-span-2" class="d-none">Código5</th>
                </tr>
              </thead>
    ...
    <div class="modal d-none asistant" id="asistant" tabindex="-1" aria-labelledby="asistantLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
              onclick="closeHelp()">Cerrar</button>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="closeCamscan()"></button>
            </div>
    ...
    <div class="container text-white mx-auto container-sm mt-4">
      <div class="row d-flex justify-content-evenly">
        ...
        <div class="col-md-4 col-6">
          ...
          <button type="button" class="btn btn-warning mt-3" id="launchCamscan" data-bs-toggle="modal" data-bs-target="#camscan">
            Escanear con cámara
          </button>
        </div>
        ...
        <div class="row-3">
          <div class="col">
            ...
            <div id="preview" class="d-none">
              <table class="table text-white form-control-xl" id="table">
                <thead>
    ...
    <div
      ...
      <button type="button" class="btn btn-success mt-3" id="getXLS" data-bs-toggle="tooltip" data-bs-placement="bottom"
        title="Generar archivo Excel a partir de la tabla">Exportar a Excel</button>
